...
from market_folder.marketmarker import TaxiMarker, TaxiStandMarker
import json
import requests
...
class MarketMapView(MapView):
    ...
    def add_taxi(self, taxi):
        ...
        marker = TaxiMarker(lat=lat, lon=lon)
    ...
    def add_taxi_stand(self, taxi_stand):
        ...
        marker = TaxiStandMarker(lat=lat, lon=lon)
